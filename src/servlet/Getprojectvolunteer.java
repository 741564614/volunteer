...
import dao.QueryProjectVolunteer;
import dao.madel.User;
import net.sf.json.JSONObject;

/**
 * Servlet implementation class Getprojectvolunteer
 */
@WebServlet("/Getprojectvolunteer")
public class Getprojectvolunteer extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Getprojectvolunteer() {
        super();
	...
	public void access(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		QueryProjectVolunteer q=new QueryProjectVolunteer();
		pic=q.queryprojectvolunteer(id);
